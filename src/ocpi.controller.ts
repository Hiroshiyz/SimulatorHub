import { Controller, Post, Put, Patch, Body, Param, HttpCode, Get } from '@nestjs/common';
...
export class OcpiController {
  ...
  async simulateSendLocation(
    ...
    return this.ocpiService.sendLocation(countryCode, partyId, locationId, body);
  }
  ...
  async simulateSendEvseStatus(
    ...
    return this.ocpiService.sendEvseStatus(countryCode, partyId, locationId, evseUid, body);
  }
  ...
  async simulateSendCancelSession(
    ...
    return this.ocpiService.sendCancelSession(countryCode, partyId, transactionNo);
  }
}
